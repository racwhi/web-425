...
//import { MenuItem } from './menu-item.model'; // Adjust the path according to your project structure
...
@Component({
  ...
  template: `
    <div>
      <h1>Our Menu</h1>
      <p>Explore our selection of handcrafted tacos, each filled with fresh ingredients
        and vibrant flavors to satisfy your cravings.</p>
