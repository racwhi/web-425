...
import { Order } from '/Users/rachelwhite/Desktop/buwebdev/web-425/data-files/virtual-taco-stand/src/app/order/order.component';
  ...
  template: `
    ...
    <ul>
      ...
      <li>
        ...
        <br />
        Price per taco:
        {{ taco.price | currency : 'USD' : 'symbol' : '1.2-2' }} <br />
...
export class OrderSummaryComponent {
  ...
  //order: import('/Users/rachelwhite/Desktop/buwebdev/web-425/data-files/virtual-taco-stand/src/app/order/order.component').Order;
}
